...
MODEL_CONFIG_CLASSES = list(MODEL_FOR_CAUSAL_LM_MAPPING.keys())  #[<class 'transformers.models.bart.configuration_bart.BartConfig'>, ...]
MODEL_TYPES = tuple(conf.model_type for conf in MODEL_CONFIG_CLASSES) # ('bart', 'bloom', 'gpt2') 
...
def main():
    ...
    # send_example_telemetry("run_clm", model_args, data_args) #TODO
    ...
    # [ ] model加载逻辑：1.根据模型名或路径model_name_or_path；2.从头训练，根据上面加载的config对象
